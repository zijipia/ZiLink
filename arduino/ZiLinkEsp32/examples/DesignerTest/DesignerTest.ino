/*
 * ZiLink ESP32 Designer Test Example
 * 
 * This example demonstrates the complete data flow from Designer to ESP32 to Server to Web.
 * 
 * Hardware Required:
...
const char* deviceId = "ESP32_DESIGNER_TEST";
...
void setup() {
  ...
  Serial.begin(115200);
  Serial.println("ZiLink ESP32 Designer Test");
  Serial.println("==========================");
  ...
  // Initialize ZiLink with WebSocket connection
  zilink.setupWebSocket(serverHost, serverPort, "/ws", deviceId, deviceToken);
  Serial.println("ZiLink WebSocket initialized!");
...
void loop() {
  ...
  // Send data to Designer dashboard every interval
